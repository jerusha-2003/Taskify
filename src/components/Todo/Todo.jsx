    ...
    return(
        <div className="todo-container absolute">
            <div className="todo-input-container">
                <input className="todo-input" value={todo} onChange={handleTodoInputChange} onKeyDown={handleTodoEnterKey}/>
            </div>
                        ...
                        return(
                            <div key={_id} className="todo-items d-flex align-center">
                                <label className={`${isCompleted ? "strike-through" : ""} todo-label`}>
                                    ...
                                    onChange={()=>handleTodoCheckChange(_id)} checked={isCompleted}/>
                                    {todo}</label>
